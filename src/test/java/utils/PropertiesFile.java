...
//    }
    ...
    public static String getPropValue(String propertiesFilePathRoot, String KeyProp) {
        properties = new Properties();
        try {
            //Khởi tạo giá trị cho đối tượng của class FileInputStream
            fileIn = new FileInputStream(projectPath + propertiesFilePathRoot);
    ...
    public static void setPropValue(String propertiesFilePathRoot, String KeyProp, String Value) {
        try {
